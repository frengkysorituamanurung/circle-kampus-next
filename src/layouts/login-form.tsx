...
const LoginForm: NextPage = ({ className, ...props }: React.ComponentProps<"div">) => {
  ...
  return (
    <div className={cn("flex items-center justify-center min-h-screen bg-gray-100", className)} {...props}>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Login to your Circle Kampus account
                </p>
              </div>
